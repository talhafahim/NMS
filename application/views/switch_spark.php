...
<div id="main-wrapper">
   ...
   <div class="page-breadcrumb">
    <div class="row">
      <div class="col-5 align-self-center">
        <h4 class="page-title">Switch Spark</h4>
                          ...
                          <div class="col-7 align-self-center">
                           ...
                           <!--  <div class="mr-2">
                            ...
                            <div class=""><small>LAST MONTH</small>
                              ...
                              <?php if(access_crud('switchspark','create')){ ?>
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Update Switch Spark</h5>
  ...
  <!-- ============================================================== -->
  <?php 
  $this->load->view('popup/add_switch_spark');
...
<script>
 function get_data() {
  // 
  var loader = `<tr><td colspan="13" class="text-center"><img src="<?php echo base_url();?>assets/img/loading.gif" alt="loading..."></td></tr>`;
  $('#switchTable').dataTable().fnDestroy();
  $('#switchTable tbody').html(loader);
  $.ajax({
    type: "POST",
    url: "<?php echo base_url();?>switches_spark/get_switches",
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#switch_insert_form").submit(function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>switches_spark/insert_switch",
...
<script type="text/javascript">
  $(document).on('click','.delete-swi',function(){
    if (confirm('Do you really want to delete this?')) {
      ...
      $.ajax({
        method: 'POST',
        url: '<?php echo base_url();?>switches_spark/delete_switch',
        data:'switid='+$switid,
        success: function(data){
          snack('#59b35a',data,'check-square-o');
          get_data();
...
<script>
  function get_update_content(val) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url();?>switches_spark/update_form",
      data:'ip='+val,
      success: function(data){
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#updateuser").submit(function() {
      $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>switches_spark/update_switch',
