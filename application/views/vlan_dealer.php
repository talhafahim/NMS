   ...
   <div class="page-breadcrumb">
    <div class="row">
      <div class="col-5 align-self-center">
        <h4 class="page-title">Dealer VLAN</h4>
                          ...
                          <div class="col-7 align-self-center">
                           ...
                           <!--  <div class="mr-2">
                            ...
                            <div class=""><small>LAST MONTH</small>
                              ...
                              <?php if(access_crud('vlan dealer','create')){ ?>
                              	<a href="<?= base_url();?>vlan/free_vlan" class="btn btn-success btn-rounded corp-add-btn cir" style="margin-right:10px;color:white;"> Free VLAN ID</a>
...
<script>
 function get_data() {
  ...
  $.ajax({
  	type: "POST",
  	url: "<?php echo base_url();?>vlan/get_vlan",
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#vlan_insert_form").submit(function() {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url();?>vlan/insert",
...
$.ajax({
  type: "POST",
  url: "<?php echo base_url();?>vlan/update_form",
  data:'ip='+val,
  success: function(data){
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#updateuser").submit(function() {
      $.ajax({
        type: "POST",
        url: '<?php echo base_url();?>vlan/update_vlan',
...
$.ajax({
  type: "POST",
  url: "<?php echo base_url();?>vlan/delete_ip",
  data:'ip='+val,
  success: function(data){
