        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <center><h3>Shared Service</h3></center>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-xs-3">
                 ...
                 <div class="col-md-9 col-xs-9">
                    <div class="card">
                        <div class="card-body">
                            <!-- <ul class="list-group">
                                <li class="list-group-item"><?= $data->id_num;?></li>
                                ...
                                <li class="list-group-item"><?= $data->pkg;?></li>
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <td><b>ID#</b></td><td><?= $data->id_num?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td><b>Vlan Name</b></td><td><?= $data->name?></td>
                                </tr> 
                                <tr>
